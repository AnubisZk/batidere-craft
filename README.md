...
![Batıdere Craft title screen](docs/screenshots/title-screen.jpg)

Batıdere Craft, Batıdere Vadisi'nde geçen web tabanlı bir micro-MMO oyunudur.
Tek kişilik çevrim dışı modla hızlıca denenebilir veya sunucu/Postgres
kurulumu ile çok oyunculu olarak oynanabilir.

- Kaynak kod: [https://github.com/AnubisZk/batidere-craft](https://github.com/AnubisZk/batidere-craft)
- Netlify: [https://batidere-craft.netlify.app/](https://batidere-craft.netlify.app/)
...
![A party gathers outside the apothecary in Batıdere](docs/screenshots/party-questing.jpg)

| | |
|:---:|:---:|
| ![Dusk at the Batıdere campfire](docs/screenshots/batidere-dusk.jpg)<br>*Dusk at the Batıdere campfire* | ![Elite pulls in the Hollow Crypt](docs/screenshots/hollow-crypt.jpg)<br>*Torch-lit elite pulls in the Hollow Crypt* |
...
| ![Old Greyjaw hunted down on the north road](docs/screenshots/old-greyjaw.jpg)<br>*Old Greyjaw, the rare spawn, run down on the north road* | ![Vendor and bags UI](docs/screenshots/vendor-and-bags.jpg)<br>*Gearing up at Demirci Mehmet's — tooltips, bags, coin* |

![Batıdere Craft](worldofclaude.png)

![Batıdere Craft community](woc_community.png)
...
Hoca Ali's storyline continues past *The Restless Dead*: **Whispers
...
```
docker compose ps          # batidere-db (postgres:16-alpine, healthcheck)
...
Name your character, pick any of the nine classes, and you're in **Batıdere
Vadisi** (levels 1-7): a market town ringed by six hubs — wolf runs north, boar
...
conspiracy, from the first restless bones outside Batıdere to **Korzul the
...
- *Hoca*: Smite, Lesser Heal, Power Word: Fortitude, Shadow Word: Pain,
