#!/bin/bash
# Batıdere Craft — EC2 first-boot setup (cloud-init user data).
#
...
# Admin dashboard domain (e.g. "admin.worldofbatidere.com"), also with an
...
echo "=== Batıdere Craft setup finished: $(date -u) ==="
