...
export const ZONE3_QUESTS: Record<string, QuestDef> = {
  ...
  q_cult_orders: {
    ...
    completionText: "Bu el yazısı... Benzerini en son Batıdere'de, Morthen'in büyü kitabında görmüştüm. Uğruna savaştığımız her mezarı aynı el yönetmiş $N.",
    objectives: [
  ...
  q_gravewyrm: {
    ...
    giverNpcId: 'brother_aldric_highwatch', turnInNpcId: 'brother_aldric_highwatch',
    text: 'Durduracak ayin kalmadı $N — yalnızca Ejder\'in kendisi kaldı; kovuğunda yarı uyanmış, Vadi\'nin ve bataklığın ölüleriyle doymuş. Yükselirse sur, bataklık, Batıdere — savunduğumuz her şey tek bir gecede düşer. Yoldaşlarını al, Ejder Kovuğu\'na in ve uzun zaman önce bir şapel avlusunda başlattığımızı bitir. Işık seni buraya kadar taşıdı; yolun kalanında onu sen taşı.',
    completionText: 'Bitti. Üç diyarın ölüleri artık dinlenebilir, dağ musallatsız uyuyor — ve bu gece buradan Batıdere\'ye kadar her çanın çaldığı isim seninki $N.',
