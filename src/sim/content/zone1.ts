// Zone 1 — Batıdere Vadisi (levels 1-7). The starter zone: town of Batıdere,
...
export const ZONE1_ZONE: ZoneDef = {
  id: 'batidere_vale',
  name: 'Batıdere Vadisi',
  zMin: -180,
  zMax: 180,
  levelRange: [1, 7],
  biome: 'vale',
  hub: { x: 0, z: 0, radius: TOWN_RADIUS, name: 'Batıdere' },
  graveyard: GRAVEYARD_POS,
  lakes: [LAKE],
  pois: [
    { x: 0, z: -3, label: 'Batıdere' },
