...
export const BASE_ITEMS: Record<string, ItemDef> = {
  ...
  // --- quest reward gear ---
  redbrook_blade: {
    id: 'redbrook_blade', name: 'Kızıldere Milis Kılıcı', kind: 'weapon', slot: 'mainhand', quality: 'uncommon',
  ...
  greyjaw_pelt_cloak: {
    id: 'greyjaw_pelt_cloak', name: 'Bozçene Postu Tozluğu', kind: 'armor', slot: 'legs', quality: 'uncommon',
  ...
  batidere_arming_sword: {
    id: 'batidere_arming_sword', name: 'Batıdere Savaş Kılıcı', kind: 'weapon', slot: 'mainhand', quality: 'common',
  ...
  batidere_chain_vest: {
    id: 'batidere_chain_vest', name: 'Batıdere Zincir Zırh Yeleği', kind: 'armor', slot: 'chest', quality: 'common',
  ...
  batidere_wool_trousers: {
    id: 'batidere_wool_trousers', name: 'Batıdere Yün Pantolonu', kind: 'armor', slot: 'legs', quality: 'common',
  ...
  webwood_silk: { id: 'webwood_silk', name: 'Ağorman İpek Bezesi', kind: 'quest', sellValue: 0, questId: 'q_spiders' },
  supply_crate: { id: 'supply_crate', name: 'Çalınan Erzak Sandığı', kind: 'quest', sellValue: 0, questId: 'q_supplies' },
  greyjaw_fang: { id: 'greyjaw_fang', name: "Koca Bozçene'nin Dişi", kind: 'quest', sellValue: 0, questId: 'q_greyjaw' },
